...
def main() -> None:
    ...
    # Minimalist Academic / Production Footer
    st.markdown(
        """
        <div style="margin-top: 52px; padding-top: 18px; border-top: 1px solid rgba(255, 255, 255, 0.06); text-align: center; font-size: 0.74rem; color: #475569; line-height: 1.6;">
            <span>Clarity • Clinical Documentation Integrity System</span>
            <span style="margin: 0 8px; color: rgba(255, 255, 255, 0.15);">|</span>
            <span>Evaluates documentation completeness against standardized checklists without clinical diagnosis</span>
        </div>
        """,
        unsafe_allow_html=True,
    )
